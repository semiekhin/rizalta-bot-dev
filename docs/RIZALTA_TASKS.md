...
### ARCHITECTURE.md + CALLBACKS.md
- **Описание:** Карта проекта для LLM-ассистента (Claude/Ollama)
- **Зачем:** Проект растёт, нужна навигация без изучения всего кода
- **Содержимое:**
  - ARCHITECTURE.md — модули, зависимости, точки входа
  - CALLBACKS.md — индекс всех callback_data patterns
- **Статус:** Запланировано на следующую сессию
