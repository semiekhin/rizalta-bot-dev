...
def filter_investment_news(items: List[Dict]) -> List[Dict]:
    """Фильтрует новости по инвестиционной тематике."""
    keywords = [
        "путин", "трамп", "цб", "ставк", "инфляц", "ввп",
        "нефть", "газ", "санкц", "рубл", "доллар", "евро",
        "рынок", "биржа", "акци", "облигац", "инвест",
        "экономик", "кризис", "срочно", "сенсац",
        "недвижимость", "ипотек", "банк", "кредит",
        "tech", "ai", "ии", "нейросет", "цифров"
    ]
