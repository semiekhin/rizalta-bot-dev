...
MODE_TITLES = {
    ...
    "calc": "💰 <b>Расчёты доходности, рассрочки и сравнение RIZALTA vs депозит</b>",
...
"""
    ...
    inline_buttons = [
        ...
        [{"text": "📊 Расчёт доходности", "callback_data": f"calc_roi_lot_{int(lot['area']*10)}"}],
        [{"text": "💳 Варианты оплаты", "callback_data": f"calc_finance_lot_{int(lot['area']*10)}"}],
