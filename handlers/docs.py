...
📋 <b>Договор с отельным оператором</b>

Выберите документ:"""

    inline_buttons = [
        [{"text": "📋 Договор ДДУ", "callback_data": "doc_ddu"}],
        [{"text": "📋 Договор с отельным оператором", "callback_data": "doc_arenda"}],
...
async def handle_send_arenda(chat_id: int):
    ...
    caption = "📋 Договор с отельным оператором ЗОНТ ХОТЕЛ ГРУПП — проект RIZALTA"
